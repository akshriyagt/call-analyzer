...
if __name__ == "__main__":
    # Render/Railway/Heroku-style hosts inject the port to bind via $PORT.
    # debug=False in production: debug mode exposes a Werkzeug interactive
    # debugger/console over HTTP, which is a remote-code-execution risk on
    # a public server.
